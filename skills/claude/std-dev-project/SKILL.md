...
| `codex-independent-review` | 2 et 4 | Revue indépendante en lecture seule |
...
- Rester en mode plan tant qu'aucune décision produit n'est arrêtée pendant
  `initiate-and-frame` et `define`.
- Tenir une tâche par étape, mais traiter `.sdp/state.json` comme la seule
  source de vérité.
